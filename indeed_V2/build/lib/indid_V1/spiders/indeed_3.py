...
class Indeed1Spider(scrapy.Spider):
    name = 'indeed-Data-Analyst-weekly-update-6'
    ...
    start_urls = ['https://www.indeed.com/jobs?q=data+analyst&l={}&radius=0&fromage=8&sort=date&limit=50&filter=0'.format(state) for state in states]
